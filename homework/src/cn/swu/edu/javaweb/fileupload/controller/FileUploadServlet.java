...
import cn.swu.edu.javaweb.fileupload.db.UploadFileDao;
import cn.swu.edu.javaweb.fileupload.exception.InvalidExtNameException;
import cn.swu.edu.javaweb.fileupload.pojo.FileUploadBean;
import cn.swu.edu.javaweb.fileupload.utils.FileUploadProperties;
import cn.swu.edu.javaweb.fileupload.utils.FileUtils;
...
//			FileUtils.delAllFile(TEMP_DIR);
			...
			e.printStackTrace();
			path = "/webpages/fileupload/upload.jsp";
