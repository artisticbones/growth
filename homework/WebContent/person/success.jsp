    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">操作成功！请等待3秒后自动返回......或点此返回<a href="<%= request.getContextPath()%>/bootstrap/index.jsp">主页面</a></h1>
		  <script type="text/javascript">
			//3秒钟之后跳转到指定的页面
			window.setTimeout("location.href='/homework/bootstrap/index.jsp';",3000);
		  </script>
        </div>
        <!-- /.container-fluid -->
